...
% including full pdf page
{
    \usebackgroundtemplate{%
        \parbox[c][\paperheight][c]{\paperwidth}{\centering\includegraphics[height=\paperheight]{GenericLSSTslides20180704-pages-2.pdf}}
        }
\frame
{
}
...
% including full pdf page
% BNL's role in LSST Camer Project
%{
%    \usebackgroundtemplate{%
%        \parbox[c][\paperheight][c]{\paperwidth}{\centering\includegraphics[height=\paperheight]{GenericLSSTslides20180704-pages-3.pdf}}
%        }
%\frame
%{
%}
...
% including full pdf page
% "Raft Production at BNL
%{
%    \usebackgroundtemplate{%
%        \parbox[c][\paperheight][c]{\paperwidth}{\centering\includegraphics[height=\paperheight]{GenericLSSTslides20180704-pages-4.pdf}}
%        }
%\frame
%{
%}
...
{
    \usebackgroundtemplate{%
        \parbox[c][\paperheight][c]{\paperwidth}{\centering\includegraphics[height=\paperheight]{GenericLSSTslides20180704-pages-5.pdf}}
        }
\frame
{
}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Get other DES codes working as well: MOF Image Deblender. 
            Currently tuning for higher LSST density using deep fields
            from DES.
